 ...
 *
 */
public class PrefixSIdentiferSpace implements IdentifierSpace<Integer> {
	...
	public PrefixSIdentiferSpace(){
	}
	
	public PrefixSIdentiferSpace(int bitsPerCoord, int size, boolean virtual){
