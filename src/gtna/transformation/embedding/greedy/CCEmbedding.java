 ...
 * 
 * Greedy embedding algorithm by Cvetkovski and Crovella into the hyperbolic plane, 
 * see paper: Cvetkovski and Crovella: "Hyperbolic Embedding and Routing for Dynamic Graphs", INFOCOM 2009
 */
public class CCEmbedding extends Transformation{
	...
	public Graph transform(Graph g) {
		...
		// create the partitions and assign each partition its identifier/coordinates
		...
		// create the id space
		Hyperbolic2DIdentifierSpaceSimple idSpace = new Hyperbolic2DIdentifierSpaceSimple(partitions);
