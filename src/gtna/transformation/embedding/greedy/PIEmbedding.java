 ...
 * 
 * Implements the greedy embedding algorithm by Herzen et al.
 * see Herzen et al.: "Scalable Routing Easy as PIE: a Practical Isometric Embedding Protocol", ICNP 2011.
 *
...
public class PIEmbedding extends Transformation {
	...
	public Graph transform(Graph g) {
		...
		while(!nodequeue.isEmpty()){
			...
			// check which neighbors have already been embedded 
		...
		MaxNormSIdentiferSpaceSimple idSpace = new MaxNormSIdentiferSpaceSimple(partitions);
