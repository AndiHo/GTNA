 ...
 * 
 * Implementation of the prefix embedding algorithm with virtual trees. 
 * The spanning tree used for the embedding is passed as SPANNINGTREE property of the graph.
 * .
 * 
 */
